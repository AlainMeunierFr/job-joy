...
describe('audit-sources-cli', () => {
  it('execute uniquement l\'audit et logue la synthese complete', async () => {
    const runAudit = jest.fn().mockResolvedValue({
      ...
      synthese: [
        { emailExpéditeur: 'jobs@linkedin.com', algo: 'Linkedin' as const, actif: 'Oui' as const, nbEmails: 3 },
        { emailExpéditeur: 'alerte@wttj.com', algo: 'Inconnu' as const, actif: 'Non' as const, nbEmails: 1 },
      ],
